    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cgst_tax', models.DecimalField(blank=True, choices=[(0, '0%'), (5, '5%'), (12, '12%'), (18, '18%'), (28, '28%')], decimal_places=2, default=0, max_digits=4, null=True)),
                ('sgst_tax', models.DecimalField(blank=True, choices=[(0, '0%'), (5, '5%'), (12, '12%'), (18, '18%'), (28, '28%')], decimal_places=2, default=0, max_digits=4, null=True)),
                ('igst_tax', models.DecimalField(blank=True, choices=[(0, '0%'), (5, '5%'), (12, '12%'), (18, '18%'), (28, '28%')], decimal_places=2, default=0, max_digits=4, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_status', models.CharField(choices=[('missing', 'missing'), ('half-done', 'half-done'), ('fulfilled', 'fulfilled')], max_length=10)),
